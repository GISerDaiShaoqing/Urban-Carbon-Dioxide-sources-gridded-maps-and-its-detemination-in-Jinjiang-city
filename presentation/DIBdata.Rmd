...
m1 <- mapview(CO30, layer.name = "Total")
m2 <- mapview(COP30, layer.name = "Resident")
m3 <- mapview(COI30, layer.name = "Industry")
m4 <- mapview(COT30, layer.name = "Transport")
sync(m1, m2, m3, m4)
```
...
m5 <- mapview(CO500, layer.name = "Total")
m6 <- mapview(COP500, layer.name = "Resident")
m7 <- mapview(COI500, layer.name = "Industry")
m8 <- mapview(COT500, layer.name = "Transport")
...
m9 <- mapview(fcmix30*100, layer.name = "R 30 m/percentage")
m10 <- mapview(fcmix500*100, layer.name = "R 500 m/percentage")
...
m19 <- mapview(PUA30*100, layer.name = "R 30 m/Percentage")
m20 <- mapview(PUA500*100, layer.name = "R 500 m/Percentage")
...
# Reference 
If you used the data[@RN912; @ZUO2019118659; @DAI2020105274; @shaoqing_dai_2019_3566073], please cited as follow:
